...
export class VoucherController {
    ...
    @Public()
    @Get('getVoucherByMaVoucher/:mavoucher')
    async getVoucherByMaVoucher(@Param('mavoucher') mavoucher: string) {
        return this.voucherService.getVoucherByMaVoucher(mavoucher);
    }
}